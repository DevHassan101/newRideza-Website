...
export default function UsersPage() {
    ...
    return (
        <div className="space-y-5">
            ...
            {/* ── Page Header ── */}
            <div>
                <h2 className="text-[20px] font-bold text-zinc-800 tracking-tight">Users Management</h2>
                <p className="text-[12.5px] text-zinc-400 mt-0.5">Manage all registered users — ban, unban, and view details</p>
            </div>
            ...
            <div className="bg-white border border-zinc-100 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div className="px-6 py-4 border-b border-zinc-100 flex flex-col sm:flex-row sm:items-center gap-3">
                    <div className="flex-1">
                        <h3 className="text-[14.5px] font-bold text-zinc-800">All Users</h3>
                        <p className="text-[11.5px] text-zinc-400 mt-0.5">
                            Manage all users ban, unban and delete
                        </p>
                    </div>
                    {/* Search */}
                    <div className="relative w-full sm:w-56">
                        ...
                        <input
                            ...
                            className="w-full border border-zinc-200 bg-zinc-50 rounded-xl pl-8 pr-3 py-2 text-[12.5px] text-zinc-700 placeholder-zinc-400 focus:outline-none focus:border-cyan-400 focus:bg-white transition-all"
                        />
                    </div>
                    {/* Status Filter */}
                    <select
                        ...
                        className="border border-zinc-200 bg-zinc-50 rounded-xl px-3 py-2 text-[12.5px] text-zinc-600 focus:outline-none focus:border-cyan-400"
                    >
                            ...
                            <thead>
                                <tr className="bg-zinc-50/80">
                                    {["User", "Contact", "Status", "Joined", "Actions"].map((h) => (
                                        <th key={h} className="text-left px-5 py-3 text-[11px] font-semibold text-zinc-400 uppercase tracking-wider">
                                            {h}
                                        </th>
                                    ))}
                                </tr>
                            ...
                            <tbody className="divide-y divide-zinc-50">
                                {users.map((u) => (
                                    <tr key={u.id} className="hover:bg-cyan-50/30 transition-colors duration-150 group">
                                        ...
                                        {/* Contact */}
                                        <td className="px-5 py-3.5">
                                            <p className="text-[12.5px] text-zinc-600">{u.email}</p>
                                            <p className="text-[11.5px] text-zinc-400 mt-0.5">{u.phone}</p>
                                        </td>
                                        {/* Status */}
                                        <td className="px-5 py-3.5">
                                            {u.isActive ? (
                                        ...
                                        {/* Joined */}
                                        <td className="px-5 py-3.5">
                                            <span className="text-[12px] text-zinc-400">{fmtDate(u.createdAt)}</span>
                                        </td>
                                        {/* Actions */}
                                        <td className="px-5 py-3.5">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="text-[11.5px] font-semibold text-zinc-500 hover:text-cyan-600 border border-zinc-200 hover:border-cyan-300 bg-zinc-50 hover:bg-cyan-50 px-2.5 py-1.5 rounded-lg transition-all"
                                                >
                                                    View
                                                </button>
                                                {/* Ban / Unban */}
                                                {u.isActive ? (
                                                    <button
                                                        ...
                                                        className="text-[11.5px] font-semibold text-red-500 hover:text-red-600 border border-red-200 hover:border-red-300 bg-red-50 hover:bg-red-100 px-2.5 py-1.5 rounded-lg transition-all"
                                                    >
                                                        Ban
                                                    </button>
                                                ) : (
                                                    <button
                                                        ...
                                                        className="text-[11.5px] font-semibold text-emerald-600 hover:text-emerald-700 border border-emerald-200 hover:border-emerald-300 bg-emerald-50 hover:bg-emerald-100 px-2.5 py-1.5 rounded-lg transition-all"
                                                    >
                                                        Unban
                                                    </button>
                                                )}
                                                ...
                                                <button
                                                    ...
                                                    className="text-[11.5px] font-semibold text-zinc-400 hover:text-red-500 border border-zinc-200 hover:border-red-200 bg-zinc-50 hover:bg-red-50 px-2.5 py-1.5 rounded-lg transition-all"
                                                    title="Delete user"
                                                >
                                                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex items-center justify-between px-6 py-3.5 border-t border-zinc-100">
                        ...
                        <div className="flex items-center gap-1.5">
                            <button
                                ...
                                className="w-8 h-8 rounded-lg border border-zinc-200 flex items-center justify-center text-zinc-500 hover:border-cyan-300 hover:text-cyan-600 hover:bg-cyan-50 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
                            >
                                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            {Array.from({ length: pagination.totalPages }, (_, i) => i + 1)
                                ...
                                .map((p, idx, arr) => (
                                    <div key={p}>
                                        ...
                                        <button
                                            onClick={() => setPage(p)}
                                            className={`w-8 h-8 rounded-lg text-[12.5px] font-semibold border transition-all ${p === page
                                                ? "bg-cyan-500 text-white border-cyan-500"
                                                : "border-zinc-200 text-zinc-600 hover:border-cyan-300 hover:text-cyan-600 hover:bg-cyan-50"
                                                }`}
                                        >
                                            {p}
                                        </button>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 border border-zinc-100">
                        ...
                        <div className="mb-4">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {(Object.entries(BAN_REASON_LABELS) as [BanReason, string][]).map(([val, label]) => (
                                    <button
                                        key={val}
                                        onClick={() => setBanReason(val)}
                                        className={`py-2 px-3 rounded-xl text-[12px] font-medium border text-left transition-all ${banReason === val
                                            ? "bg-red-500 text-white border-red-500"
                                            : "bg-zinc-50 text-zinc-600 border-zinc-200 hover:border-red-300"
                                            }`}
                                    >
                                        {label}
                                    </button>
                        ...
                        <div className="mb-5">
                            ...
                            <textarea
                                ...
                                placeholder="Extra detail likho..."
                                rows={3}
                            ...
                            {detailModal.user.isActive ? (
                                <button
                                    onClick={() => {
                                        ...
                                        setBanModal({ open: true, user: detailModal.user });
                                    }}
                                ...
                                <button
                                    onClick={() => {
                                        handleUnban(detailModal.user!.id);
                                        setDetailModal({ open: false, user: null });
                                    }}
